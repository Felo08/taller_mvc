            ...
            customButtons: {
                myCustomButton: {
                    click: function() {
                        ...
                        window.open(base_url+'mvc/controllers/CCuadrosDeTurno.php?action=exportarExcelCuadroDeTurnos&y='+moment.format('YYYY')+'&m='+moment.format('MM')+'&fecha='+moment.format('YYYY-MM'),'_blank');;
                    }
                },
                myCustomButton1: {
                    click: function() {
