$(document).ready(function(){
	...
	$("#bnt-guardar").click(function(e){
		...
		if($('#frm-medica').valid() && $('#frm-medica').valid()){
			loader = open_overlay();
			$.post(base_url+'mvc/controllers/Cingresoamanecer.php',$("#frm-medica").serialize(),function(respuesta){
				if(respuesta.rpt){
	...
	$(document).on('keyup',"#buscar_usuario",function(){
      $.post(base_url+'mvc/controllers/Cingresoamanecer.php',$("#frm_buscar").serialize(),function(respuesta)
      {
