...
function validarFormulario(){
	...
	$("#btn-enviar").click(function(e){
		...
		if($("#frm-usuario").valid()){
			...
			$.post(base_url+'mvc/controllers/Ceps.php',$("#frm-usuario").serialize(),function(respuesta){
...
$(document).on('click', ".btn_edit_product", function()
	{
			...
			$.post(base_url+'mvc/controllers/Ceps.php',{action:"consultar_usuario",'id_cedula':$(this).attr('id_tercero')},function(respuesta){
			//console.log(respuesta);
...
$(document).on('click',".btn_eliminar_producto",function()
	{
     ...
     var txt;
	var r = confirm("Desea bloquear la eps?");
		if (r == true) 
		{
    		$.post(base_url+'mvc/controllers/Ceps.php',{action:"eliminar",'id_cedula':$(this).attr('id_tercero')},function(respuesta)
				{
					console.log(respuesta);
			      if(respuesta.rpt)
			      {
...
$(document).on('click', "#bnt_guardar_producto", function()
	{
	//	$("#load_ediatr").show();
		$.post(base_url+'mvc/controllers/Ceps.php',$("#frm-editar-productos").serializeArray(),function(respuesta){
			if(respuesta.rpt){
			$.notify(respuesta.mensaje,"success");
