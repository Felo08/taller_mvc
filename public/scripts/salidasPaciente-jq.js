...
$(document).ready(function(){
    ...
    $("#cedula").change(function(e){
        if($(this).val() != null){
            $.post(base_url+'mvc/controllers/CInventario.php?action=obtenerKardeInventarioPaciente',{id_paciente:$(this).val()},function(data){
                var html = '';
    ...
    $('#guardar').on('click',function(e){
        ...
        if($('#form_salidaPaciente').valid()){
            ...
            $.post(base_url+'mvc/controllers/CInventario.php?action=guardarInventarioPaciente', $('#form_salidaPaciente').serialize(), function(data){
                if(data.rpt){
...
function recargarGrid() {
    $('#tbl_salidas_residente').load(base_url+'mvc/controllers/CInventario.php?action=recargarSalidasMedicamentosPaciente',$('#frm_filtro').serialize());
}
