...
function validarFormulario(){
	...
	$("#btn-enviar").click(function(e){
		...
		if($("#frm-usuario").valid()){
			...
			$.ajax({
		        url: base_url+'mvc/controllers/Csolicitudingreso.php?action=insertar',
		        type: 'POST',
		        dataType: "JSON",
		        data: data,
		        processData: false,
...
$(document).on('keyup',"#buscar_usuario",function(){
  //    console.log($(this).val());
      ...
      $.post(base_url+'mvc/controllers/Csolicitudingreso.php',$("#frm_buscar").serialize(),function(respuesta)
      {
...
function recargar_grid(){
	 $.post(base_url+'mvc/controllers/Csolicitudingreso.php',{action:"recargar_usuarios"},function(respuesta)
            {
            	$("#contenedor_list_productos").html(respuesta);
            });
}