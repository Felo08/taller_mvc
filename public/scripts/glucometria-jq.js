...
console.log("sssss");
	...
	$("#id_cedula").select2({
		...
		$("#id_glucosa").select2({
	    placeholder: "Buscar Item Glucometria",
	    allowClear: true,
	    language: "es",
	    ajax: { 
	        url: base_url+'mvc/controllers/Cglucosa.php?action=obteneritemglucosa',
	        cache: "true",
	        type:'POST',
	        dataType: 'json',
	        data: function (data, page) {
	        	...
	        	data.fecha = $("#id_fecha").val();
	        	//data.turno = $("#id_turno").val();
	        	data.enfermera = $("#id_cedula").val();
	            return data;
	        }
	    },
	});

$("#id_medicacion").select2({
	    placeholder: "Buscar medicacion",
	    allowClear: true,
	    language: "es",
	    ajax: { 
	        url: base_url+'mvc/controllers/Cglucosa.php?action=Obtenertipoinsulina',
	        cache: "true",
	        type:'POST',
	        dataType: 'json',
	        data: function (data, page) {
